...
//            ListModel {
//            id: myModel
//            ListElement { Type: "登陆"; User: "123"; Time: "2016/6/5 23:00"; Content:"useername:123登陆成功"}
//            ListElement { Type: "设置"; User: "123"; Time: "2016/6/5 23:10"; Content:"模式设置为制冷模式"}
//            ListElement { Type: "处理从控机请求"; User: "123"; Time: "2016/6/5 23:20"; Content:"模式设置为制冷模式"}
//        }
        delegate: Rectangle {
            height: 102
            width: parent.width
